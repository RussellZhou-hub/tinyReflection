...
/* Field 3 */
self->fields[2].m_type = GetType<unsigned long long>();
self->fields[2].m_flags = Field::kFlagsNull | Field::kFlagsSerialized;
self->fields[2].m_serializedWidth = sizeof(unsigned long long) * 8;
...
functionRet0.m_type = GetType<unsigned long long>();
functionRet0.m_flags = 0/*TODO*/;
functionRet0.m_serializedWidth = sizeof(unsigned long long) * 8;
...
/* Field 3 */
self->fields[2].m_type = GetType<std::vector<std::basic_string<char>>>();
self->fields[2].m_flags = Field::kFlagsNull | Field::kFlagsSerialized;
self->fields[2].m_serializedWidth = sizeof(std::vector<std::basic_string<char>>) * 8;
